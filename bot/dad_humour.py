...
def add_to_image(name, time):
  font = ImageFont.truetype("images/Roboto-Regular.ttf", 30)
  
  img = Image.open("images/dad.jpg")
  img.load()
  ...
  if len(time) == 5:
    font2 = ImageFont.truetype("images/Roboto-Regular.ttf", 23)
    draw.text((404, 150), time, (255, 255, 255), font=font2)
  else:
    font2 = ImageFont.truetype("images/Roboto-Regular.ttf", 24)
